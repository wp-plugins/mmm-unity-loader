...
/*
Plugin Name: Mmm Unity Player
Plugin URI: http://www.mediamanifesto.com
Description: A simple shortcode for loading unity3d files : [MmmUnityLoader src="YourFileUrlHere.unity3d" height="800" width="600"]Click to Load Text Here[/MmmUnityLoader]
Version: 0.1
